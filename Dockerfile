...
# setup build image
FROM --platform=$BUILDPLATFORM golang:1.24.1@sha256:c5adecdb7b3f8c5ca3c88648a861882849cc8b02fed68ece31e25de88ad13418 AS operator-build
...
FROM --platform=$TARGETPLATFORM registry.access.redhat.com/ubi9-micro:9.5-1739776878@sha256:d115f8aad9c4ae7ee21ae75bbcb3dc2c5dbf9b57bf6dad6dcb5aac5c02003bde AS base
FROM --platform=$TARGETPLATFORM registry.access.redhat.com/ubi9:9.5-1741850090@sha256:8d53b60617e53e4dbd6c0d485c569801f48dbeb40b48c8424a67e33a07320968 AS dependency
